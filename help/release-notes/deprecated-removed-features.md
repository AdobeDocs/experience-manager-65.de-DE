...
In diesem Abschnitt werden Funktionen aufgeführt, die seit AEM 6.5 als veraltet gekennzeichnet wurden. Im Allgemeinen werden Funktionen, deren Entfernung in einer zukünftigen Version geplant ist, zuerst als veraltet gekennzeichnet und es wird eine Alternative bereitgestellt.
...
In diesem Abschnitt werden Funktionen aufgeführt, die aus AEM 6.5 entfernt wurden. In früheren Versionen wurden diese Funktionen als veraltet gekennzeichnet.

| Bereich | Funktion | Ersatz | Version (SP) |
|--- |--- |--- |--- |
| Commerce | AEM CIF Classic wurde entfernt. | Sie sollten zu [AEM CIF](/help/commerce/cif/migration.md) migrieren. Falls Sie weiterhin CIF Classic benötigen, wurde ein Kompatibilitätspaket erstellt. Wenden Sie sich in diesem Fall an den [Adobe-Kunden-Support](https://experienceleague.adobe.com/de?support-solution=General#support). | 6.5.22.0 |

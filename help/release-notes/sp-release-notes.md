...
* Im [!DNL Experience Manager] Kopfzeilenabschnitt werden beim Navigieren im Durchsuchen-Modus jetzt Bildschirmlesehilfen angekündigt,
   ...
   * die Fehlermeldung, wenn unter der Option &quot; [!ICONTROL Benutzer] &quot;in [!UICONTROL Eigenschaftsvariablen als] Feld eingegeben und der Fokus korrekt auf das Textfeld (NPR-33804) verschoben wird.
...
Das UberJar für Experience Manager 6.5.6.0 ist im Repository [Adobe Public Maven verfügbar](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.6/).

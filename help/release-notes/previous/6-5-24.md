...
* Der niedrige Kontrast in der Sperrstatusmeldung, die im Workflow zum Sperren/Entsperren der Seite angezeigt wird, wurde korrigiert. Die Nachricht erreicht jetzt ein Verhältnis von 4,5:1, wodurch die Lesbarkeit und die ADA-Konformität für Autoren verbessert werden. (SITES-27270)
...
* **FORMS-15256** Beim Upgrade von AEM 6.5 Forms Service Pack 18 oder 19 auf Service Pack 20 oder 21 ist ein JSP-Kompilierungsfehler aufgetreten. Dieser Fehler hinderte sie daran, adaptive Formulare zu öffnen oder zu erstellen. Er hat auch Probleme mit anderen AEM-Schnittstellen verursacht. Diese Schnittstellen umfassten den Seiteneditor, die AEM Forms-Benutzeroberfläche, den Workflow-Editor und die Benutzeroberfläche der Systemübersicht.
  ...
  2. Löschen Sie das Paket `com.adobe.granite.ui.commons-5.10.26.jar`.
...
## Enthaltene OSGi- und Inhaltspakete {#osgi-bundles-content-packages}

Die folgenden ZIP-Dateien enthalten die Textdokumente, die die in dieser Version [!DNL Experience Manager] 6.5 Service Pack enthaltenen OSGi-Bundles und Inhaltspakete auflisten:

<!-- UPDATE FOR EACH NEW RELEASE -->

* [OSGi-Bundles](/help/release-notes/assets/65240-bundles.zip)
* [Inhaltspakete](/help/release-notes/assets/65240-packages.zip)

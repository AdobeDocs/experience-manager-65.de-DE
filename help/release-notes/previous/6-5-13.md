...
[!DNL Experience Manager] 6.5.13.0 enthält neue Funktionen, wichtige von Kundschaft angeforderte Verbesserungen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen, die seit der ersten Verfügbarkeit von 6.5 im April 2019 veröffentlicht wurden. [Installieren Sie dieses Service Pack](#install) auf [!DNL Experience Manager] 6.5.

Zu den wichtigsten Funktionen und Verbesserungen, die in [!DNL Adobe Experience Manager] 6.5.13.0 eingeführt wurden, gehören:
...
* „Jeder“ hat JCR:write auf `/content/usergenerated/etc/commerce/smartlists`. (NPR-35230)
...
* Bei einer Bereitstellung mit MongoDB und mehreren Instanzen installieren Sie [!DNL Experience Manager] 6.5.13.0 mit dem Package Manager auf einer der Autoreninstanzen.

>[!NOTE]
>
>Adobe rät davon ab, das Paket [!DNL Experience Manager] 6.5.13.0 zu entfernen oder zu deinstallieren.
...
>[!NOTE]
>
>[!DNL Experience Manager] 6.5.13.0 unterstützt nicht die Installation von Bootstrap.
...
https:// Das UberJar für [!DNL Experience Manager] 6.5.13.0 ist im [Maven Central Repository(](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.13/)) verfügbar.
...
In den folgenden Textdokumenten sind die in [!DNL Experience Manager] 6.5.13.0 enthaltenen OSGi-Bundles und Inhaltspakete aufgeführt:

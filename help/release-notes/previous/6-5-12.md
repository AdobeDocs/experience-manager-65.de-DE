...
[!DNL Adobe Experience Manager] 6.5.12.0 enthält neue Funktionen, wichtige von Kundinnen und Kunden angeregte Verbesserungen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen, die seit der Verfügbarkeit der Version 6.5 im April 2019 veröffentlicht wurden. Das Service Pack wird auf [!DNL Adobe Experience Manager] 6.5 installiert.

Die wichtigsten in [!DNL Adobe Experience Manager] 6.5.12.0 eingeführten Funktionen und Verbesserungen sind:
...
Im Folgenden finden Sie die Liste der Fehlerbehebungen in Version [!DNL Experience Manager] 6.5.12.0.
...
* [Plattform] Die Versionsnummer von „xmlns:metatype“ in „metatype.xml file of commons-httpclient“ ist „https://www.osgi.org/xmlns/metatype/v1.0.0“ statt „https://www.osgi.org/xmlns/metatype/v1.2.0“ (NPR-37865).
...
* Nach der Aktualisierung auf Version 6.5.10.0 zeigt die Seite mit Asset-Eigenschaften eine unnötige HTML-Rendering-Meldung an (CQ-4336994).
...
* `getAemFormContainer` gibt nach der Installation von AEM Forms 6.5.10.0 einen Null-Pointer-Ausnahme zurück (NPR-37881).
...
* Multithread-Sperren des PDF Generator-Dienstes nach einer zufälligen Zeitdauer für AEM 6.5.7.0 Forms (NPR-38053).
...
* Probleme beim Speichern von UTF-8-Sonderzeichen als Teil eines Workflows auf der Veröffentlichungsinstanz von AEM 6.5.10.0 Forms (NPR-37673).
...
* Installieren Sie bei einer Bereitstellung mit MongoDB und mehreren Instanzen Experience Manager 6.5.12.0 mithilfe des Paket-Managers auf einer der Autoreninstanzen.
...
Es gibt zwei Möglichkeiten, [!DNL Experience Manager] 6.5.12.0 automatisch auf einer laufenden Instanz zu installieren:
...
In den nachfolgenden Textdokumenten sind die in [!DNL Experience Manager] 6.5.12.0 enthaltenen OSGi- und Inhaltspakete aufgeführt:

* [Liste der in Experience Manager 6.5.12.0enthaltenen OSGi-Pakete](/help/release-notes/assets/65120_bundles.txt)
* [Liste der in Experience Manager 6.5.12.0enthaltenen Inhaltspakete](/help/release-notes/assets/65120_packages.txt)

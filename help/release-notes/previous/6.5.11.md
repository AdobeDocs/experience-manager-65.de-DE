...
* In [!DNL Dynamic Media]in der Benutzeroberfläche zum Erstellen eines Videokodierungsprofils die [!UICONTROL Smart Crop Ratio] für die Barrierefreiheit gekennzeichnet ist, sodass Bildschirmlesehilfen sie entsprechend ankündigen.
...
* PDF-Verarbeitungsfehler wird nicht auf [!DNL Experience Manager] wenn bei [!DNL Scene7] (CQ-4331145)
...
* Wenn es einen eingebetteten Container-Workflow gibt, erhalten Sie mehrere Workflow-Fertigstellungs-E-Mails, selbst wenn Sie die `Notify on Complete of Container Workflow` (NPR-37280).
...
>[!NOTE]
>
>Wenn Sie noch kein Upgrade auf AEM 6.5.11.0 Forms durchgeführt haben, installieren Sie das Add-On-Paket für AEM Forms 6.5.11.1 direkt. Wenn Sie AEM 6.5.11.0 Forms installiert haben, empfiehlt Adobe ein Upgrade auf AEM 6.5.11.1 Forms.

...
* Wenn ein Benutzer ein Feld zum ersten Mal in einem adaptiven Formular konfiguriert, wird die Option zum Speichern einer Konfiguration nicht im Eigenschaften-Browser angezeigt. Das Problem lässt sich beheben, indem Sie im selben Editor ein anderes Feld des adaptiven Formulars konfigurieren.

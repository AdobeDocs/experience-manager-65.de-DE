...
* Wenn der Benutzer versucht, XDP-Formulare von PDF in HTML5-Formulare zu konvertieren. Beim Rendern der HTML5-Formulare für kambodschanische Schriftarten treten einige Probleme auf:
   * Zeilenumbrüche werden in HTML5-Formularen wiedergegeben. (CQ-4322508)
   * Listen werden in HTML5-Formularen nicht korrekt wiedergegeben. (CQ-4322317)
   * Beim Rendern der HTML5-Formularwiedergabe werden zusätzliche Leerzeichen angezeigt. (CQ-4322509)
...
* Wenn der Benutzer versucht, XDP-Formulare von PDF in HTML5-Formulare zu konvertieren, sind einige der behobenen Probleme:
   * Unterstützung für Farsi, als LTR zu rendern.
   * Unterstützung für RTL in Kombination mit LTR-Text.
   * Unterstützung für Bildrotation.
   * Unterstützung für die kambodschanische Sprache wird hinzugefügt. Um die Unterstützung für Combodian zu aktivieren, müssen Sie das Flag als `CTL=true` beim Rendern des HTML5-Formulars.
...
* Der Service Pack-Download ist auf Adobe [Software Distribution](https://experience.adobe.com/#/downloads/content/software-distribution/de/aem.html) verfügbar.

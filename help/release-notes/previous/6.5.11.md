...
* Wenn Sie AEM 6.5 Service Pack 11 installieren, kann es zu Problemen mit der Suchfunktion für Assets (Bilder) kommen. In diesem Fall wird empfohlen, ein Upgrade auf 6.5.12.0 durchzuführen und den entsprechenden Hotfix zu installieren.

...
* In den Feldern zum Filtern der Suche nach Stil und Ausrichtung wird der automatisch vervollständigte Wert nicht auf die Suchabfrage angewendet. NPR-30620: Hotfix für CQ-4275724
...
* Beim Sortieren der Suchabfrage nach Relevanz werden [!DNL InDesign]-Dokumente zusammen mit [!DNL InDesign]-Vorlagen zurückgegeben. Hotfix für CQ-4273864
...
* Bei einem neuen Blueprint werden bei mehr als 40 Einträgen nur die ersten 40 Einträge angezeigt. Der Blueprint zeigt für den Rest der Einträge leere Zeilen an (NPR-31182).
...
* [!DNL Experience Manager] standardmäßige E-Mail-Absender kann über TLS 1.2 keine E-Mails an einen Remote-SMTP-Server senden. NPR-30476: Hotfix für GRANITE-26605

## Projekte {#projects-6520}

* DAM:folderThumbnailPaths-Werte werden nicht aktualisiert und zeigen auch nach dem Löschen der Assets im Ordner alte Miniaturen an. NPR-30424: Hotfix für CQ-4273667
...
* Ein Upgrade der -Instanz von 6.3.3.2 auf 6.5 führt zu doppelten OSGi-Konfigurationen. NPR-30130: Hotfix für CQ-4274016
...
Zu den wichtigsten Merkmalen [!DNL Experience Manager] 6.5.2.0 Formulare gehören:

...
* Unterstützung für das [Konvertieren farbiger Formulare in adaptive Formulare](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html) mithilfe von [!DNL Automated Forms Conversion service].
...
* Das Feld „Ordnername“ beim Erstellen eines neuen Ordners ist anfällig für gespeichertes Cross-Site-Scripting (GRANITE-30094).
...
* Wenn Sie beim Erstellen einer neuen Adobe Launch-Konfiguration eine Eigenschaft auswählen, wird die folgende Fehlermeldung ausgegeben (NPR-33947):

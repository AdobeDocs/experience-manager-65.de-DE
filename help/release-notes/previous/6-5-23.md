...
* [!DNL Experience Manager] 6.5.23.0 erfordert [!DNL Experience Manager] 6.5. Detaillierte Anweisungen finden [ in ](/help/sites-deploying/upgrade.md)Upgrade-Dokumentation“. <!-- UPDATE FOR EACH NEW RELEASE -->
...
UberJar für [!DNL Experience Manager] 6.5.23.0 ist im [Maven Central-Repository](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.23/) verfügbar. <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* **FORMS-15681**:When Der Brief wird in der Druckvorschau angezeigt. Der Inhalt wird geändert. Einige Leerzeichen verschwinden und bestimmte Buchstaben werden durch `x` ersetzt.
...
* **FORMS-23881**: Bei AEM Forms-JEE-Bereitstellungen, die mit dem 6.5.23.0-Vollinstallationsprogramm eingerichtet werden, kann der Ausgabe-Service Anfragen nicht verarbeiten, wenn beim Aufruf eine benutzerdefinierte XCI-Datei angegeben wird. Um dieses Problem zu beheben, installieren Sie das neueste Service Pack von AEM 6.5.24.0 Forms über das [Software Distribution](https://experience.adobe.com/#/downloads/content/software-distribution/de/aem.html)-Portal.
...
* [Liste der in Experience Manager 6.5.23.0enthaltenen OSGi-Pakete](/help/release-notes/assets/65230-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Liste der in Experience Manager 6.5.23.0enthaltenen Inhaltspakete](/help/release-notes/assets/65230-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->

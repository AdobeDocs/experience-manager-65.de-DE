...
* **FORMS-15681**:When Der Brief wird in der Druckvorschau angezeigt. Der Inhalt wird geändert. Das heißt, dass einige Leerzeichen ausgeblendet werden und bestimmte Buchstaben durch `x` ersetzt werden.

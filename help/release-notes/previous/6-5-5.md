...
Adobe Experience Manager 6.5.5.0 ist ein wichtiges Update, das neue Funktionen, wichtige von Kundschaft angeforderte Verbesserungen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen enthält, die seit der allgemeinen Verfügbarkeit von Version 6.5 im **2019 veröffentlicht**. Es kann auf Adobe Experience Manager 6.5 installiert werden.
...
* Wenn eine Experience Manager Sites-Seite Teil eines großen Content-Sets mit mehreren Live Copies ist, kann die Vorschau des Seitenversionsverlaufs nicht geladen werden (NPR-33311).
...
### Verbesserungen der Barrierefreiheit (6.5.5.0) {#accessibility-sites}
...
>[!IMPORTANT]
>
>Windows-Benutzern von [!DNL Experience Manager desktop app] wird empfohlen, ein Upgrade auf [Desktop-Programm-Version 2.0.3.2](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html?lang=de#what-is-new) durchzuführen, um auf das DAM-Repository in [!DNL Adobe Experience Manager 6.5.5.0] Instanz zuzugreifen. da beim Zugriff auf das DAM-Repository in [!DNL Adobe Experience Manager] 6.5.5.0-Instanz mithilfe der Desktop-Anwendung Version 2.0.2 Probleme auftreten können.

**Verbesserte Barrierefreiheit in Experience Manager Assets**

* Es ist jetzt möglich, den Tastaturfokus auf die Liste [!UICONTROL Kommentare] und eine anklickbare Option zu setzen, um Versionskommentare zu [!UICONTROL erstellen] unter [!UICONTROL Neue Version erstellen] im Assets-Bedienfeld [!UICONTROL Timeline] (NPR-33424).
...
* Die Sortierfunktion für sortierbare Kopfzeilen (in der Listenansicht, [!UICONTROL Timeline-Ansicht] und auf der Seite [!UICONTROL Veröffentlichung verwalten]) wird nun von Sprachausgaben ausgegeben und die Sortiersteuerelemente in Spaltenüberschriften sind über die Tastatur zugänglich (NPR-32979).
...
* Ausgabedarstellungen für intelligenten Zuschnitt sind im Dialogfeld für den Asset-Download nicht verfügbar (NPR-33167).

* In Protokollen tritt beim Öffnen der Ausgabedarstellungsleiste für eine PDF unter einem Ordner mit Profil für intelligenten Zuschnitt eine Ausnahme auf (CQ-4294201).
...
* In 6.5.5.0 behobene Leistungsprobleme (CQ-4279206):
...
* Die Adobe Launch-Konfigurationsseite zeigt nicht alle Einträge an (NPR-33011).
...
* Das Laden der Option [!UICONTROL Timeline] in der linken Leiste dauert länger als erwartet (NPR-32851).

...
[!DNL Experience Manager] 6.5.16.0 enthält neue Funktionen, wichtige von Kundschaft angeforderte Verbesserungen, Fehlerkorrekturen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen, die seit der ersten Verfügbarkeit von 6.5 im April 2019 veröffentlicht wurden. [Installieren Sie dieses Service Pack](#install) auf [!DNL Experience Manager] 6.5. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* Nach einem Upgrade auf das Service Pack von AEM 6.5.15.0 funktioniert die Konvertierung von PostScript zu PDF nicht. (NPR-39765) und (NPR-39764)
...
* Nach dem Upgrade auf das Service Pack von AEM 6.5.15.0 funktioniert die Umleitung relativer URLs im Visual Editor nicht mehr. (NPR-39947)
* Wenn Benutzende ein Upgrade auf das Service Pack von AEM 6.5.15.0 durchführen, funktioniert die Weiterleitung nicht mehr mit Internet Explorer. (CQ-4351745)
* Nach einem Upgrade auf das Service Pack von AEM 6.5.15.0 wird das Überschriften-Tag von HTML nicht erkannt. HTML-Code für das Überschriften-Tag wird im HTML-Formular als Text angezeigt. (NPR-39915)
...
* [!DNL Experience Manager] 6.5.16.0 erfordert [!DNL Experience Manager] 6.5. Detaillierte Anweisungen finden [ in ](/help/sites-deploying/upgrade.md)Upgrade-Dokumentation“. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* Wenn auf der JBoss® 7.1.4-Plattform das Service Pack von AEM 6.5.16.0 installiert wird, schlägt `adobe-livecycle-jboss.ear` Bereitstellung fehl.
...
In den folgenden Textdokumenten sind die in [!DNL Experience Manager] 6.5.16.0 enthaltenen OSGi-Bundles und Inhaltspakete aufgeführt: <!-- UPDATE FOR EACH NEW RELEASE -->

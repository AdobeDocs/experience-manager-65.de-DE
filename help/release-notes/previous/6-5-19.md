...
* **[Verbesserte Barrierefreiheit in AEM Forms Designer](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-5/forms/pdf/using-designer.pdf)**: AEM Forms Designer führt die folgenden Verbesserungen der Barrierefreiheit ein:

   * AEM Forms Designer unterstützt jetzt barrierefreie Inhaltsverzeichnisse über neue `<TOC>`- und `<TOCI>`-Tags, sodass Autorinnen und Autoren diese Rollen über die Registerkarte „Barrierefreiheit“ Teilformularen zuweisen können. Die Funktion unterstützt Inhaltsverzeichnisstrukturen auf mehreren Ebenen, beschriftete Einträge, nummerierte Verweise und span-Unterstrukturen, sodass Bildschirmlesehilfen Inhaltsverzeichnisinhalte ordnungsgemäß identifizieren und darin navigieren können.

   * AEM Forms Designer unterstützt jetzt die Konfiguration von Barrierefreiheitseigenschaften für Tabellenzellen, einschließlich Umfang, Zeilenbereich und Spaltenbereich. Dadurch können Bildschirmlesehilfen und Hilfseinrichtungen die Tabellenstruktur in generierten PDF-Dateien korrekt interpretieren. Autorinnen und Autoren können diese Eigenschaften direkt im Dialogfeld Zelleneigenschaften festlegen und sie in der XML-Source-Ansicht überprüfen. Die konfigurierten Eigenschaften werden korrekt in der getaggten PDF-Ausgabe angezeigt und können mit dem Acrobat-Tabellen-Editor validiert werden.
...
* Ein Helligkeits-Kontrastverhältnis für Text auf einer Seite von weniger als 4.5:1 beeinträchtigt Personen mit eingeschränktem Sehvermögen. (ASSETS-25756)
...
* Die Reihenfolge der Tags wird in PDF nach dem Zufallsprinzip geändert, selbst wenn das Tagging in Forms Designer korrekt ist. (LC-3921313) 
...
* [!DNL Experience Manager] 6.5.19.0 erfordert [!DNL Experience Manager] 6.5. Detaillierte Anweisungen finden [ in ](/help/sites-deploying/upgrade.md)Upgrade-Dokumentation“. <!-- UPDATE FOR EACH NEW RELEASE -->
...
1. Das OSGi-Bundle `org.apache.jackrabbit.oak-core` Version 1.22.17 oder höher (Zu verwendende Web-Konsole: `/system/console/bundles`).
...
* Beim Versuch, Inhaltsfragmente, Sites oder Seiten zu verschieben, zu löschen oder zu veröffentlichen, gibt es ein Problem, wenn Inhaltsfragmentreferenzen abgerufen werden, da die Hintergrundabfrage fehlschlägt. Das heißt, die Funktionalität funktioniert nicht.

...
* Im Bannertext wird neben dem Namen der Viewer-Vorgabe für intelligenten Zuschnitt zweimal der Status „unverarbeitet“ angezeigt (CQ-4283517).
...
* Datums- und Uhrzeitformatbeschränkungen sind in den Feldbeschriftungen von Datumsfeldern angegeben, damit die Benutzer das Datum über die Tastatur im richtigen Format eingeben können.
...
### Konfigurieren von [!DNL Experience Manager Assets] mit [!DNL Brand Portal] (6.5.4.0) {#configure-assets-bp}

...
>Sie können die entsprechenden Versionen der [!DNL Azul Zulu]-JDKs von [Adobe Software Distribution](https://experience.adobe.com/#/downloads/content/software-distribution/de/aem.html) herunterladen.
...
* Wenn Sie ein Upgrade Ihrer [!DNL Experience Manager]-Instanz von Version 6.5 auf 6.5.10.0 durchführen, können Sie `RRD4JReporter`-Ausnahmen in der Datei `error.log` anzeigen. Starten Sie die Instanz neu, um dieses Problem zu beheben.

...
* Nach dem Upgrade auf [!DNL Experience Manager] 6.5 generiert die Vorschau der Ausgabedarstellungen `Only empty tenantId is currently supported` Fehler . NPR-29986: Hotfix für CQ-4272353
...
* Auf der [!DNL Experience Manager]-Oberfläche sollte ein zusätzlicher Eintrag für die aktuelle Version des Assets im Timeline-Verlauf angezeigt werden, der den neuesten Eincheck-Kommentar von [!DNL Adobe Asset Link] enthält. Hotfix für CQ-4262864
* Inhaltsfragment-Timeline zeigt eine Fehlermeldung an, wenn Eigenschaften fehlen. Hotfix für CQ-4272560
...
Zu den wichtigsten Merkmalen [!DNL Experience Manager Forms] 6.5.1.0 gehören:
...
* Der Überprüfungsschritt für adaptive Forms in [!DNL Experience Manager] 6.5 wurde wiederhergestellt. Hotfix für CQ-4269583
...
* Adaptive Forms App hat die Unterstützung für Microsoft Windows 8.1 eingestellt. Hotfix für CQ-4265274
...
* Die Summenfunktion in XDP funktioniert nicht, wenn die Datenwörterbuchelemente den Datentyp „Zahl“ enthalten. Hotfix für CQ-4227403
...
In den folgenden Textdokumenten sind die in [!DNL Experience Manager] 6.5.1.0 enthaltenen OSGi-Bundles und Inhaltspakete aufgeführt

Liste der in [!DNL Experience Manager] 6.5.1.0 enthaltenen OSGi-Bundles

[Datei abrufen](/help/release-notes/assets/6_5-bundle-list.txt)

Liste der in [!DNL Experience Manager] 6.5.1.0 enthaltenen Inhaltspakete

[Datei abrufen](/help/release-notes/assets/6_5-content-package-list.txt)

...
[!DNL Experience Manager] 6.5.14.0 enthält neue Funktionen, wichtige von Kundinnen und Kunden angeregte Verbesserungen, Fehlerkorrekturen sowie Leistungs-, Stabilitäts- und Sicherheitsverbesserungen, die seit der ersten Verfügbarkeit von 6.5 im April 2019 veröffentlicht wurden. [Installieren Sie dieses Service Pack](#install) auf [!DNL Experience Manager] 6.5. <!-- UPDATE FOR EACH NEW RELEASE -->

Zu den wichtigsten Funktionen und Verbesserungen gehören:

* **[Unterstützung der Barrierefreiheit von Listen in AEM Forms Designer](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-5/forms/pdf/using-designer.pdf)**: AEM Forms Designer ermöglicht es Autorinnen und Autoren jetzt, barrierefreie Listenstrukturen zu erstellen, indem sie Teilformularen Listen-, Listenelement- und Listenbeschriftungsrollen über die Registerkarte Barrierefreiheit zuweisen. Die Funktion unterstützt einfache, nummerierte, Aufzählungs- und verschachtelte Listen mit ordnungsgemäßer `<L>`, `<LI>`, `<Lbl>` und `<Lbody>` Tag-Generierung für die Kompatibilität mit Bildschirmlesehilfen. Dadurch wird sichergestellt, dass Formularlisten den Barrierefreiheitsstandards von PDF/UA entsprechen, was die Navigation und das Inhaltsverständnis für Benutzende von Hilfstechnologien verbessert.
...
* Für den Textinhalt **[!UICONTROL Sortieren nach]** im Hauptnavigationsbereich der Datei in der Kartenansicht liegt kein Kontrastverhältnis von mindestens 4.5:1 zur Hintergrundfarbe vor. (ASSETS-6926)
...
* Intelligente Zuschnitte, die für Bilder mit transparentem Hintergrund erstellt wurden, haben einen weißen Hintergrund. (ASSETS-13148)
...
* Assets werden nicht in das Dynamic Media-Konto hochgeladen, nachdem der Workflow „Dynamic Media Reprocess Assets“ für Assets mit falschem Auftrags-Handle ausgeführt wurde. (ASSETS-12084, ASSETS-9877)
...
* Nach der Installation von AEM 6.5 Forms Service Pack 12 (6.5.12.0) sind im Schritt „Aufgabe zuweisen“ von AEM-Workflows keine Optionen mehr außer der Option zum Schließen der Aufgabe verfügbar. (NPR-38743)
...
* Es wurde die Möglichkeit hinzugefügt, in Forms Reader Text für Hyperlinks anzugeben. (NPR-36221)
...
* Die Anmeldung beim Paket-Manager zur Bereitstellung von Updates ist nicht möglich. (NPR-38646)
...
* Bei der Überprüfung des Aufzählungsfelds für Inhaltsfragmente tritt beim ersten Laden des Inhaltsfragments ein Fehler auf. (SITES-7140)
...
* Wenn Sie ein Inhaltsfragmentmodell erstellen und ein Aufzählungsfeld des Typs Dropdown hinzufügen, schlägt die korrekte Validierung für _`is required`_fehl. (NPR-38237)
...
* Eine Benutzersitzung kann keine `ModifiableValueMap`-Instanz für die Gruppen erhalten, um die direkte Gruppenzugehörigkeit einzurichten. (NPR-38710)
...
* [!DNL Experience Manager] 6.5.14.0 erfordert [!DNL Experience Manager] 6.5. Detaillierte Anweisungen finden [ in ](/help/sites-deploying/upgrade.md)Upgrade-Dokumentation“. <!-- UPDATE FOR EACH NEW RELEASE -->

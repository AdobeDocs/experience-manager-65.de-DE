---
title: '''[!DNL Adobe Experience Manager] 6.5.8 Versionshinweise zum Service Pack'
...
Das UberJar für Experience Manager 6.5.8.0 ist im [Maven Central Repository](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.8/).

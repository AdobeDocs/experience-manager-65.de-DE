...
* Wenn ein Administrator [!DNL Experience Manager Assets] 6.5.4 mit Brand Portal über Adobe Developer Console, die [!DNL Brand Portal] Der Benutzer kann das Asset eines Beitragsordners nicht aus [!DNL Brand Portal] nach [!DNL Experience Manager] (NPR-33046).

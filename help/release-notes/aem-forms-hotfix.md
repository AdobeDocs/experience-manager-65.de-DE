...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>(GRANITE-63681) Die Authentifizierung von Formulardatenmodell-Connectoren kann fehlschlagen, da die erforderlichen Schlüsselwörter und Regex-Muster standardmäßig nicht zulässig sind.</li>
    </ul>
    </td>
  </tr>
    <tr>

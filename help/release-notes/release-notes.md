...
AEM 6.5.21, 6.5.22, 6.5.23 und AEM 6.5 LTS GA enthalten das `org.apache.sling.scripting.jsp:2.6.0`-Bundle, das von einem bekannten Problem betroffen ist. Dieses Problem tritt normalerweise bei hoher Auslastung auf, wenn viele gleichzeitige Anfragen von der AEM-Instanz verarbeitet werden.

...
Nach dem Speichern der neuen Abrufkonfiguration müssen Sie die Eigenschaften des Abonnement-E-Mail-Importeurs weiter ändern, um das Protokoll von `POP3` zu ändern `emailreply`.

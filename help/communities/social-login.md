...
>[!NOTE]
>
>Wenn Sie bei älteren AEM-Versionen in Protokollen mit einer Ausnahme konfrontiert sind: **Kann kein Token aus dieser Datei extrahieren, **aktualisieren Sie auf die neueste CFP für diese AEM-Version.
...
1. Unter Knoten /oak:index/ntBaseLucene-oauth/indexRules/nt:base/properties:
   ...
   * Eigenschaften des Knotens oauthid-123****

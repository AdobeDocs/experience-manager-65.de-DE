...
Besuchen Sie das Tutorial [Erste Schritte mit AEM Communities für Aktivierung](/help/communities/getting-started-enablement.md) , um sich mit den Funktionen für die Aktivierung vertraut zu machen.

#### Benutzerverwaltung {#user-management}

Aktivieren Sie alle Kontrollkästchen für [Benutzerverwaltung](/help/communities/sites-console.md#user-management)

* Site-Besucher zur Selbstregistrierung zulassen
* Site-Besucher können die Site ohne Anmeldung anzeigen
* , damit Mitglieder Nachrichten von anderen Community-Mitgliedern senden und empfangen können
* , damit Sie sich bei Facebook anmelden können, anstatt sich zu registrieren und ein Profil zu erstellen
* , um die Anmeldung bei Twitter zu ermöglichen, anstatt sich zu registrieren und ein Profil zu erstellen

>[!NOTE]
>
>In einer Produktionsumgebung müssen benutzerdefinierte Facebook- und Twitter-Anwendungen erstellt werden. Siehe [Social-Anmeldung bei Facebook und Twitter](/help/communities/social-login.md).

![Community-Site-Einstellungen](assets/site-settings.png)

#### TAGGING {#tagging}

Die Tags, die auf Community-Inhalte angewendet werden können, werden durch Auswahl von AEM-Namespaces gesteuert, die zuvor über die [Tagging-Konsole](/help/sites-administering/tags.md#tagging-console) definiert wurden (z. B. der [Tutorial-Namespace](/help/communities/setup.md#create-tutorial-tags)).
...
* Standard-Übersetzungsanbieter und Konfiguration verlassen
* Es ist kein Bedarf für einen globalen Store vorhanden, da es keine Sprachkopien gibt
* ganze Seite **übersetzen auswählen**
* Standardpersistenzoption beibehalten
...
* **Site löschen**Wählen Sie das Symbol zum Löschen, um die Community-Site in Communities > Sites zu löschen. Durch diese Aktion werden alle mit der Site verknüpften Elemente entfernt, z. B. UGC, Benutzergruppen, Assets und Datenbankdatensätze.
...
>
>1. Navigieren Sie zu Tools > Vorgänge > Replizierungsmenü.
1. Wählen Sie &quot;Agenten beim Autor&quot;.
1. Wählen Sie &quot;Standardagent (publish)&quot;.
1. Wählen Sie neben &quot;Einstellungen&quot;die Option &quot;Bearbeiten&quot;.
...
1. Ändern Sie in URI die Anschlussnummer 4503 in die gewünschte Anschlussnummer >
   * zum Beispiel zur Verwendung von Port 6103:
https://localhost:6103/bin/receive?sling:authRequestLogin=1
1. Wählen Sie &quot;OK&quot;.
1. (Optional) Wählen Sie &quot;Löschen&quot;oder &quot;Wiederholen erzwingen&quot;, um die Replikationswarteschlange zurückzusetzen.
...
Wenn Änderungen nicht gespeichert werden können, stellen Sie sicher, dass der Knotenname `localhost.4503`mit einem Punkt-Trennzeichen und nicht `localhost:4503` mit einem Doppelpunkt-Trennzeichen versehen ist, da es sich nicht um ein gültiges Namespace-Präfix `localhost`handelt.

![chlimage_1-70](assets/chlimage_1-70.png)

#### Fehlerbehebung: Fehler bei Umleitung {#troubleshooting-fail-to-redirect}

Die Zeichenfolge &#39;**$**&#39; am Ende der `sling:match`Zeichenfolge für reguläre Ausdrücke ist von entscheidender Bedeutung, sodass nur exakt `https://localhost:4503/` zugeordnet wird. Andernfalls wird der Umleitungswert jedem Pfad vorangestellt, der möglicherweise nach server:port in der URL existiert. Wenn AEM also versucht, zur Anmeldeseite umzuleiten, schlägt es fehl.

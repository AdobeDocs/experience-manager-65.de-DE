...
Neben den rein von AEM verwalteten Inhalten kann eine CIF-Seite in der Regel Commerce-Daten anzeigen, die dynamisch über GraphQL von Adobe Commerce abgerufen werden. Während sich die Seitenstruktur selbst möglicherweise nie ändert, kann sich der Commerce-Inhalt ändern, z. B. wenn sich einige Produktdaten (z. B. Name oder Preis) in Adobe Commerce ändern.

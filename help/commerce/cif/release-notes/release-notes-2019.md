...
description: AEM Content and Commerce – Versionshinweise 2019
...
* Die Kategorie-/Produktauswahl wurde verbessert, um die angegebene Adobe Commerce-Store-Ansicht in einem Setup mit mehreren Stores zu berücksichtigen.
...
* Funktion mit mehreren Vorlagen, mit der Autoren bestimmte Produktdetailseiten oder Produktlistenseiten anreichern können. Autoren können einfach eine benutzerdefinierte Produktdetailseite oder Produktlistenseite erstellen und mit der Produkt- oder Kategorieauswahl die benutzerdefinierte Seite bestimmten Produkten oder Kategorien zuweisen.
...
* Die Checkout-Komponente enthält Adressformulare sowie Optionen zur Auswahl von Zahlung und Versandmethode.
...
* Das Einbetten des CIF-Connectors in den CIF-Archetyp ist jetzt optional, um Entwicklern mehr Flexibilität zu bieten.
...
* GraphQL-Caching wurde für bestimmte GraphQL-Abfragen über HTTP GET aktiviert, um die Reaktionszeit zu verkürzen.

* Die Produktbeschreibungsansicht ist in der AEM-Produktkonsole aktiviert.

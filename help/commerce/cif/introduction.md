...
Mit Adobe Experience Manager Content and Commerce können Marken schneller skalieren und Innovationen vorantreiben, um differenzierte Commerce-Erlebnisse zu schaffen und von den steigenden Online-Ausgaben zu profitieren. Adobe Experience Manager Content and Commerce kombiniert die interaktiven, Omni-Channel- und personalisierten Erlebnisse in Experience Manager mit einer beliebigen Anzahl von Lösungen für den Handel, um in allen Bereichen der Customer Journey für differenzierte Erlebnisse zu sorgen, die Wertschöpfungszeit zu verkürzen und höhere Conversion Rates zu erzielen.

## So bringt Content and Commerce Kundschaft auf Erfolgskurs

Angesichts der stetig steigenden Kundenerwartungen an Erlebnisse im Online-Handel sind Marken gezwungen, differenzierte Erlebnisse zu bieten und schneller mehr Inhalte bereitzustellen. Die Implementierung einer Content-Management-Plattform ist jedoch häufig mit einem hohen Zeit- und Budgetaufwand für die Entwicklung grundlegender Elemente wie benutzerdefinierter Komponenten und Authoring-Tools sowie mit Kosten für Wartung und Upgrades verbunden. Experience Manager Sites bietet Content and Commerce als Add-On-Modul für Experience Manager, das vordefinierte Commerce-Kernkomponenten, Authoring-Tools und eine Referenz-Storefront bereitstellt, um Veröffentlichungen zu beschleunigen, die nahtlose Zusammenarbeit von Teams zu ermöglichen und die Conversion Rates zu steigern.
...
* Anreichern und Differenzieren von Kundenerlebnissen
* Optimieren des Authorings mit Commerce-Datenzugriff

## Einführung in AEM Commerce Integration Framework (CIF) {#cif-intro}

Diese Projekte müssen die Komplexität der Integration einer Lösung für den Handel bewältigen. Eine Commerce-Lösung kann alles sein – von einer kommerziellen Lösung wie Adobe Commerce bis hin zu einer Reihe benutzerdefinierter Commerce-Services. Die Integration hängt in hohem Maße von den Anwendungsfällen und dem Ökosystem ab. Sie betrifft in der Regel verschiedene Bereiche und tritt in vielen unterschiedlichen Formen auf:
...
* Fähigkeit, sich schnell anzupassen und Innovationen im Back- und Frontend zu entwickeln
...
Diese Komplexität öffnet die Tür für potenzielle Fehlerquellen, erhöhte Gesamtbetriebskosten, Verzögerungen und eine geringere Wertrealisierung. Aus diesen Gründen wurde das Commerce Integration Framework (CIF) entwickelt, ein Add-on für Experience Manager. CIF erweitert Experience Manager um Commerce-Funktionen und standardisiert die Integration mit Commerce-Engines. Das Ergebnis ist eine zukunftssichere, stabile und skalierbare Lösung mit niedrigeren Gesamtbetriebskosten. Sie ermöglicht technische und geschäftliche Innovationen mit agilen Tools und nahtlos integrierten Funktionen, um ansprechende Commerce-Erlebnisse zu gestalten.
...
Leistungsstarke CIF-Tools in AEM ermöglichen es Content-Erstellenden, schnell umfassende und personalisierte Commerce-Erlebnisse auf skalierbare und bereitstellungsunabhängige Weise zu erstellen, um Geschäftschancen optimal zu nutzen.
...
* Mit zunehmender digitaler Reife steigt auch der Bedarf an Erlebnis-Management. CIF bietet Funktionen für das Produkterlebnis-Management, die ohne zusätzlichen Aufwand für die IT schrittweise integriert werden können.
* Bereit für Omni-Channel: CIF unterstützt eine Vielzahl von Touchpoint-Technologien (Server-seitig, Hybrid, Client-seitig) mit Mustern, Beschleunigern und Kernkomponenten.

...
Der Wert **Ja** entspricht der Ganzzahl **1**. Dies ist nützlich, wenn wir die GraphQL-Abfrage in Java™ schreiben.
...
1. Fügen Sie einen Logger hinzu, um das Debugging des Java™-Codes zu unterstützen:

...
Um Ihre PWA Studio-App einzurichten, folgen Sie der [Dokumentation zu PWA Studios](https://developer.adobe.com/commerce/pwa-studio/tutorials/) von Adobe Commerce.
...
Folgen Sie der Dokumentation zu AEM-Inhaltsfragmenten, um einen GraphQL-Endpunkt für Ihr AEM-Projekt einzurichten. Fügen Sie in Ihrem AEM-Projekt außerdem die folgenden Konfigurationen hinzu, damit Ihre PWA Studio-Anwendung auf den GraphQL-Endpunkt zugreifen kann:

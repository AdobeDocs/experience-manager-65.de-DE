...
1. Add the component **Text &amp; Personalization** from the sidekick. Diese Komponente ist Teil der Newslettergruppe. Öffnen Sie die Komponente im Bearbeitungsmodus.

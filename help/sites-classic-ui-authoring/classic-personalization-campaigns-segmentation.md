...
description: Die Segmentierung ist bei der Erstellung einer Kampagne eine grundlegende Überlegung. Normalerweise müssen vor dem Start einer Kampagne bereits Segmente definiert sein.
contentOwner: User

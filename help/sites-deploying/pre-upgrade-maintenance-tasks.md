...
* [Aktualisieren des Datenbankschemas bei Bedarf](/help/sites-deploying/pre-upgrade-maintenance-tasks.md#upgradethedatabaseschemaifneeded)
...
1. Erstellen Sie eine Sicherung der Benutzer, die das Problem verursachen. Sie können dies über Package Manager tun. For more information, see [How to Work with Packages.](/help/sites-administering/package-manager.md)
1. Löschen Sie die Benutzer, die das Problem verursachen. Nachfolgend finden Sie eine Liste der Benutzer, die unter diese Kategorie fallen könnten:

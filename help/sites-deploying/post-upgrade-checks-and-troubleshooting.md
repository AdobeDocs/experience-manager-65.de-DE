...
Nach einem [ersetzenden Upgrade](/help/sites-deploying/in-place-upgrade.md) sollten folgende Schritte durchgeführt werden, um das Upgrade abzuschließen. Es wird davon ausgegangen, dass AEM mit der 6.5-JAR-Datei gestartet und die upgegradete Codebasis bereitgestellt wurde.
...
Nach dem Upgrade sollte ersichtlich sein, dass die Oak-Version auf Version **1.10.2** aktualisiert wurde. Um die Oak-Version zu überprüfen, navigieren Sie zur OSGi-Konsole und suchen Sie nach der entsprechenden Version der Oak-Pakete: Oak Core, Oak Commons, Oak Segment-TAR.
...
Es wird zudem empfohlen, die Paket-Liste einer aktuellen AEM 6.5-Instanz mit der upgegradeten zu vergleichen, um nicht aktualisierte Pakete zu ermitteln. Dadurch kann der Bereich der zu suchenden Elemente in der Datei `error.log` eingegrenzt werden.

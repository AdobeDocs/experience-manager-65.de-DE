...
In Ausnahmefällen, in denen Funktionen nicht rückwärtskompatibel gehalten werden konnten, können Probleme mit der Abwärtskompatibilität von Paketen und Inhalten durch die Installation eines Kompatibilitätspakets für 6.4 gemildert werden (weitere Informationen zum Herunterladen finden Sie unter Setup weiter unten). Dieses Compat-Paket hilft in den meisten Fällen bei der Wiederherstellung der Kompatibilität mit AEM 6.4-kompatiblen Anwendungen.

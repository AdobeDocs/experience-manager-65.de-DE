...
description: Java API-Schnellstart (SOAP) für den Application Manager-Dienst
contentOwner: admin
...
>[!NOTE]
>
>Die Java-API-Kurzanleitung (SOAP) unter „Programmieren mit AEM Forms“ basiert auf Forms. Wenn Sie ein anderes Betriebssystem wie etwa Unix verwenden, ersetzen Sie Windows-spezifische Pfade durch Pfade, die vom jeweiligen Betriebssystem unterstützt werden. Wenn Sie einen anderen J2EE-Anwendungsserver verwenden, stellen Sie sicher, dass Sie gültige Verbindungseigenschaften angeben. Siehe [Einstellung von Verbindungseigenschaften](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties).

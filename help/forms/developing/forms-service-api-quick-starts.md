...
Das folgende Codebeispiel rendert ein Formular mit dem Namen *Loan.xdp* auf dem Client mithilfe der Java-API des Forms-Diensts. Beachten Sie, dass der Formularentwurf Teil einer Anwendung ist und durch Verwendung des Inhaltsstamm-URI-Werts `repository:///` referenziert wird. (Siehe [Rendern von Forms am Client](/help/forms/developing/rendering-forms.md#rendering-forms-at-the-client).)

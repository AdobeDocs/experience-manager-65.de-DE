...
![Überblick über Analytics](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>In diesem Fall [Legacy Analytics](/help/forms/using/configure-analytics-forms-documents.md) und Launch-Analytics-Funktionen gleichzeitig aktiviert sind, **Analytics starten** hat Vorrang.
...
1. Tippen Sie auf das Feld und wählen Sie ![Regeleditor](/help/forms/using/assets/edit-rules-icon.svg), um die Seite mit dem Regeleditor zu öffnen.

...
* **** Vorausgefüllt: Die folgenden Felder dienen als Eingaben in die Aufgabe:
   ...
   * **** Wählen Sie einen benutzerdefinierten Prefill-Dienst: Wählen Sie den prefill-Dienst aus, um die Daten abzurufen, und füllen Sie das Dokument für den interaktiven Kommunikationswebkanal oder die Agent-Benutzeroberfläche vorab aus.

   * **** Verwenden Sie den oben ausgewählten interaktiven Kommunikationsdienst zum Vorausfüllen: Verwenden Sie diese Option, um den Vorfülldienst der interaktiven Kommunikation zu verwenden, der in der Dropdownliste Interaktive Kommunikation verwenden definiert ist.
...
* **Gesendete Informationen:** Die folgenden Felder dienen als Ausgabespeicherorte für die Aufgabe:
   ...
   * **** Anlagen speichern unter: Speichern Sie die in einer Aufgabe bereitgestellten Formularanhänge. Sie können die Anlagen mit einem Pfad speichern, der relativ zur Nutzlast ist, oder sie in einer Variablen des Dokumentdatentyps speichern.
...
Wählen Sie die Option &quot; **Variable** &quot;, um die in einer Variablen des Typs &quot;Dokument&quot;, &quot;XML&quot;oder &quot;JSON&quot;gespeicherte Dateianlage abzurufen.
...
* **** Wählen Sie Dokument aus, mit dem Sie unterschreiben möchten: Sie können ein Dokument an einem Speicherort im Verhältnis zur Nutzlast auswählen, Nutzlast als Dokument verwenden, einen absoluten Pfad des Dokuments angeben oder das Dokument abrufen, das in einer Variablen des Dokumentdatentyps gespeichert ist.
...
>[!NOTE]
>
>Mithilfe von Variablen können Sie die DDX-Datei für Eingabedokumente angeben. Speichern Sie die DDX-Datei in einer Variablen des Typs &quot;Dokument&quot;oder &quot;XML&quot;.

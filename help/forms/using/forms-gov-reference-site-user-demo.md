...
description: Verwenden Sie fiktive Benutzer und Gruppen, um AEM Forms-Aufgaben mithilfe des Demopakets "Wir.Gov"auszuführen.
seo-description: Verwenden Sie fiktive Benutzer und Gruppen, um AEM Forms-Aufgaben mithilfe des Demopakets "Wir.Gov"auszuführen.
...
![Berechtigter Benutzer](/help/forms/using/assets/aya_tan_new.png)

* **George Lang**: We.Gov agency Business Analyst

![Berechtigter Benutzer](/help/forms/using/assets/george_lang.png)

* **Camila Santos**: We.Gov Agency CX Lead

![Berechtigter Benutzer](/help/forms/using/assets/camila_santos.png)

Folgende Gruppen sind ebenfalls enthalten:
...
1. **Mobile View**:We.Gov-Benutzer, der eine Mobilansicht mit einem Browser in der neuen Größe repliziert.
1. **Desktop-Ansicht**: Wir.gov Benutzer, um die Demo auf einem Laptop oder Desktop anzuzeigen.
1. **Formular** vor dem Bildschirm: Formular auf der Homepage der Website We.Gov.
...
1. **Adobe Inbox**: Befindet sich in der oberen Menüleiste [Glockensymbol] im AEM-Backend.

   *https://&lt;aemserver>:&lt;port>/aem/start.html*

1. **E-Mail-Client**: Bevorzugte Methode zum Anzeigen Ihrer E-Mails (Google Mail, Outlook)
1. **CTA**: Aktionsaufruf
1. **Navigieren**: So suchen Sie einen bestimmten Referenzpunkt auf der Browserseite.

## Demo zur Mobilansicht {#mobile-view-demo}
...
![Berechtigter Benutzer](/help/forms/using/assets/aya_tan_new-1.png)
...
1. Treffen Sie in jedem Dropdown-Feld eine Auswahl.
   ...
   1. Hinweis: Wenn der Benutzer mehr als 200.000 USD pro Jahr verdient, sind die Benutzer nicht berechtigt.
...
Aya stellt fest, dass sie berechtigt ist, und beginnt, ihren Antrag auszufüllen, um auf ihrem Mobilgerät Service anzufordern.
...
1. Verwenden Sie die folgende **dynamische Logik** , um dynamische Funktionen mithilfe der Dropdownliste **Familienstatus** zu demonstrieren:
...
1. Klicken Sie auf die hervorgehobene gelbe Registerkarte, um das Dokument zu signieren.
   ...
   ![Dokument](/help/forms/using/assets/sign_document_new.png) unterschreiben ![Signieren Sie das Testdokument](/help/forms/using/assets/sign_test_document.png)

## Regierungsvertreter (George) {#government-agent-george}

![Regierungsagent George](/help/forms/using/assets/george_lang-1.png)

**** Dieser Abschnitt: George ist ein Geschäftsanalyst der Regierung Agentur Aya ist ein Antrag auf einen Dienst von. George verfügt über ein Dashboard, in dem er alle Serviceanforderungsanwendungen sehen kann, die ihm zur Überprüfung zugewiesen wurden.
...
1. (Citizen-Rolle) Öffnen Sie Ihren E-Mail-Client, um die an Aya gesendete E-Mail anzuzeigen.

   ![E-Mail an Aya anzeigen](/help/forms/using/assets/email_client.png)
...
1. Im CRM können Sie alle Informationen sehen, die aktualisiert werden können
   ...
   1. Fügen Sie optional eine neue Anrufaktivität direkt in Dynamics hinzu.
...
1. Blättern Sie in Ihrem E-Mail-Client nach oben und klicken Sie auf &quot;**View welcome kit online**&quot;.
...
**** Dieser Abschnitt: Camila navigiert zu einem Dashboard, in dem sie die KPIs der Agentur sehen kann, z. B. die Prozentsätze der Bürger, die ein Formular für Serviceanfragen ausfüllen und abbrechen, die durchschnittliche Dauer von der Antragstellung bis zur Genehmigung/Ablehnung und Interaktionsstatistiken für die von ihr an die Bürger gesendeten Vorteilshandbücher.

### Camila prüft Berichte zu Sites (We.Gov Adobe Analytics) {#camila-reviews-sites-reporting-we-gov-adobe-analytics}

1. Navigieren Sie zu *https://&lt;aemserver>:&lt;port>/sites.html/content*
1. Wählen Sie die &quot;**AEM Forms We.Gov-Site**&quot;, um die Seiten der Site anzuzeigen.
...
1. Wählen Sie im gleichen Menü &quot;**Einstellung** anzeigen&quot;und wählen Sie die anzuzeigenden Spalten im Abschnitt &quot;**Analytics**&quot;aus.
...
### Camila prüft Formularberichte (We.Gov Adobe Analytics) {#camila-reviews-forms-reporting-we-gov-adobe-analytics}
...
1. Warten Sie, bis die Seite geladen wurde, und zeigen Sie die Analytics-Berichtsdaten an.

   ![Analyseberichtsdaten](/help/forms/using/assets/analytics_report_data_updated.jpg)

...
AEM 6.5 Forms Service Pack 12 (6.5.12.0) bietet das neueste vollständige Installationsprogramm für AEM 6.5 Forms on JEE.

Adobe empfiehlt die Verwendung von <a href="https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=de"> AEM 6.5.12.0 Forms on JEE </a> komplettes Installationsprogramm (veröffentlicht am 03. März 2022) anstelle von AEM 6.5. Installationsprogramm (veröffentlicht am 08. April 2019).
...
>
> Mit Version 6.5 werden folgende Infrastrukturkomponenten, die eine geringe Nutzung unter unseren Kunden aufweisen, nicht mehr unterstützt:
> ・IBM DB2-Datenbank
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>Microsoft SQL Server 2016 (Veraltet)</p> </td>
   <td><p>Repository-Mikrokernel</p> </td>
   <td><p>Unterstützt</p> </td>
  </tr>
  <tr>
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>JBoss® Enterprise Application-Plattform (EAP) 7.1.4 <sup>[2] [3] [7]</sup> (Veraltet) </p> </td>
   <td><p>A: Unterstützt</p> </td>
...
<table>
 <tbody>
  ...
  <tr>
   <td> Microsoft Windows Server 2016 (64-Bit) (nicht mehr unterstützt)</td>
   <td>A: Unterstützt</td>
   <td>Service Packs und wichtige Updates</td>
  </tr>
  <tr>
...
- 03. Dezember 2020
   - Unterstützung mit AEM Forms 6.5.7.0 oder höher für die folgende Plattform hinzugefügt:

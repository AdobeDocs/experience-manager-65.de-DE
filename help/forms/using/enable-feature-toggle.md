...
Ab AEM 6.5 SP23 müssen Sie das Bundle [com.adobe.granite.toggle.impl.dev](http://com.adobe.granite.toggle.impl.dev/) nicht mehr installieren, da es bereits mit dem Forms-Add-on AEM Service Pack installiert ist.

...
**Primäre OCRLlanguage:** Die Sprache, in der die OCR-Engine die Zeichen identifizieren soll. Die Standardeinstellung ist „Deutsch (Deutschland)“.
...
[Einstellungen anderer Anwendungen (nur Windows)](#other-applications-settings-windows-only)
   ...
   Um zu einem anderen Abschnitt zu wechseln, klicken Sie auf dessen Link auf der Webseite oder verwenden Sie die Schaltflächen **[!UICONTROL Weiter]**oder **[!UICONTROL Zurück]**.
...
Die Einstellung „Exportdateityp“ im Abschnitt mit den Einstellungen für „Adobe PDF-Export“ wird zum Konvertieren einer PDF-Datei in ein anderes Format verwendet. Der Standardwert ist HTML 4.01 mit Cascading Style Sheets (CSS) 1.0(&amp;ast;.htm, &amp;ast;.html).

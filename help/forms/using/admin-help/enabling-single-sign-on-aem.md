...
1. Führen Sie an einer Eingabeaufforderung den Befehl `ktpass` mit folgenden Argumenten aus:
   ...
   **BEREICH:** Der Active Directory-Bereich für den Domain-Controller. In diesem Beispiel ist der Wert auf „UM.LC.COM“ festgelegt. Stellen Sie sicher, dass der Bereich in Großbuchstaben eingegeben wird. Führen Sie die folgenden Schritte aus, um den Bereich für Windows 2003 zu bestimmen:

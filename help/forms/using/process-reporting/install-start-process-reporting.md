...
1. &#x200B;
   ...
   * (Für Linux, AIX und Solaris) Öffnen sie die Datei `[JBoss root]/bin/run.conf.sh` in einem Editor.

1. Fügen Sie das folgende JVM-Argument hinzu: `-Dreporting.publisher.cron = <expression>.`

...
Viele neuere Browser-Versionen bieten eigene eingeschränkte Unterstützung für XFA-basierte PDF-Formulare. Obwohl diese Browser XFA-basierte PDF-Formulare öffnen können, sind die gebotenen Funktionen begrenzt. Wenn Sie ein XFA-basiertes PDF-Formular nicht in einem modernen Browser öffnen oder senden können, verwenden Sie eine der folgenden Methoden:

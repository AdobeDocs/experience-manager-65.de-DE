...
1. Im Bereich Eigenschaften :
   ...
   1. Tippen Sie auf ![Speichern](/help/forms/using/assets/done_icon.png), um die Eigenschaften zu speichern.
...
1. Tippen ![save](assets/done_icon.png) , um die Eigenschaften zu speichern.

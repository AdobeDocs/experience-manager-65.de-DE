...
Verwenden Sie **FDM_Create_First_IC**, wie im Abschnitt [Formulardatenmodell](../../forms/using/create-form-data-model0.md) erstellen beschrieben, als Formulardatenmodell zum Erstellen von Dokumentfragmenten in diesem Tutorial.
...
1. Im Abschnitt **Variable erstellen**:
   ...
   ![Variable des String-Typs erstellen](assets/variable_create_string_new.png)
...
1. Setzen Sie den Cursor neben dem Feld **Alternative Kontaktnummer** und doppelklicken Sie auf die Eigenschaft &quot;Kunde** > **alternatemobilenumber**&quot;.

...
+ Upgrade AEM Forms {#upgrade-aem-forms}
   ...
   + Aktualisierung von AEM Forms on JEE {#aem-forms-jee-upgrade}
      ...
      + [Checkliste für die Aktualisierung und Planung](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
...
+ Adaptive Formulare - Erweitertes Authoring {#adaptive-forms-advanced-authoring}
   ...
   + [Einbetten eines adaptiven Formulars oder einer interaktiven Kommunikation in AEM Sites-Einzelseitenanwendung](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ Workflows {#workflows}
   ...
   + [Anmelden bei AEM Forms-Arbeitsabläufen](/help/forms/using/forms-workflow-logs.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [Designer-Lernprogramme](http://www.adobe.com/go/learn_aemforms_designer_quick_start_65)
   + [Designer-Beispiele](http://www.adobe.com/go/learn_aemforms_designer_samples_65)
...
+ Entwicklerreferenz {#developer-reference}
   ...
   + [AEM Forms Java API-Referenz](https://helpx.adobe.com/experience-manager/6-5/forms/javadocs/index.html)

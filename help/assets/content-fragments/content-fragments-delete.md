...
Zum Beispiel bei der Bearbeitung von Varianten, bei der Bearbeitung von Metadaten oder bei der Verwaltung von zugehörigen Inhalten.
...
>
>Diese Aktion wendet jedoch dieselben Löschberechtigungen auch auf *alle* anderen Asset-Typen an.
...
Die Berechtigungen zum `add` und `modify` können auch in CRXDE Lite oder über die User Management-Konsole verwaltet werden.

...
Wenn Sie [!DNL Adobe Experience Manager Assets] Benutzer wird Lightbox automatisch erstellt, wenn Sie sich zum ersten Mal bei der Anwendung anmelden. Lightbox bezieht sich ausschließlich auf Ihre eigenen Anmeldungen. Andere Benutzer können nicht auf Ihren Lightbox-Ordner zugreifen.

## Hinzufügen von Assets zu Lightbox {#adding-assets-to-lightbox}

1. Aus dem [!DNL Assets] -Benutzeroberfläche die Assets auswählen, die Sie zu Lightbox hinzufügen möchten.
1. Ziehen Sie die Assets in den Bereich **[!UICONTROL In Lightbox ablegen]**. Lassen Sie die Maustaste los, wenn die Dropzone aktiv wird und sich die Bezeichnung in **[!UICONTROL Zum Hinzufügen ablegen]**.
...
1. Klicken **[!UICONTROL Lightbox]** , um die darin enthaltenen Assets anzuzeigen.
...
1. Navigieren Sie zur Konsole Sammlungen und klicken Sie auf Lightbox , um die zugehörigen Assets anzuzeigen.

...
Wenn Sie Benutzer sind, die [!DNL Adobe Experience Manager Assets] sind, wird Lightbox bei der ersten Anmeldung bei der Anwendung automatisch erstellt. Lightbox bezieht sich ausschließlich auf Ihre eigenen Anmeldungen. Andere Benutzer können nicht auf Ihren Lightbox-Ordner zugreifen.

## Hinzufügen von Assets zu Lightbox {#adding-assets-to-lightbox}

1. Wählen Sie in der Benutzeroberfläche [!DNL Assets] die Assets aus, die Sie zu Lightbox hinzufügen möchten.
...
1. Klicken Sie in der Symbolleiste auf **[!UICONTROL Remove]**.

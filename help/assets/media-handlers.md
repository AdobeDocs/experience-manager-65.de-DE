...
1. Installation von ImageMagick: Siehe [ImageMagick-Dokumentation](https://www.imagemagick.org/script/download.php).
...
Wenn beispielsweise ImageMagick auf dem Datenträger installiert ist, der den AEM-Server hostet, und Sie einen Prozessschritt mithilfe von [!UICONTROL CommandLineProcess] als Implementierung erstellen und die folgenden Werte als [!UICONTROL Prozess-Argumente] verwenden:

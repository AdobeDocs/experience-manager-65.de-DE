...
++ Gibt es Lizenzierungskosten im Zusammenhang mit der intelligenten Bildbearbeitung? {#are-there-any-licensing-costs-associated-with-smart-imaging}
...
+++Wie wird die intelligente Bildbearbeitung für ein Konto aktiviert? {#what-is-the-process-for-enabling-smart-imaging-for-my-account}
...
+++ Wann wird voraussichtlich ein Konto für die intelligente Bildbearbeitung aktiviert? {#when-can-i-expect-my-account-to-be-enabled-with-smart-imaging}
...
+++ Kann die intelligente Bildbearbeitung für eine beliebige Anforderung deaktiviert werden?{#turning-off-smart-imaging}
...
++ + Bei intelligenter Bildbearbeitung: Welche Image Serving-Befehle werden unterstützt oder ignoriert? {#support-ignore}
...
+++ Warum wird manchmal ein JPEG-Bild anstelle von WebP an Chrome zurückgegeben? {#jpeg-returned}
...
+++ Warum funktioniert die Funktion Device Pixel Ratio (dpr) bei Composite-Bildern nicht erwartungsgemäß? {#composite-images}

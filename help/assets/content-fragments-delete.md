...
1. **Die verschiedenen Unterentitäten, die ein Inhaltsfragment bilden. Z. B. Varianten, Unterknoten.** 
   ...
   * **Berechtigungen:** Siehe [Nur für Editor-Funktionen erforderliche Berechtigungen](/help/assets/content-fragments-delete.md#permissions-required-for-editor-functionality-only).

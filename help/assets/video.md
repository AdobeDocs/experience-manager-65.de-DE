...
>[!NOTE]
>
>Bevor Sie mit Videos in Dynamic Media arbeiten, stellen Sie sicher, dass Ihr AEM-Administrator die Cloud Service für Dynamic Media bereits aktiviert und konfiguriert hat, entweder im Dynamic Media - Scene7-Modus oder im Dynamic Media - Hybrid-Modus.
>
...
1. **Konfigurieren Sie Videos in Dynamic Media** anhand der folgenden Schritte:
   ...
   * Verknüpfen Sie das Profil für die Videoverarbeitung mit einem oder mehreren Ordnern, in die Sie Ihre primären Quellvideos hochladen möchten.
   ...
   * Laden Sie Ihre primären Quellvideos in die Ordner hoch. Sie können Videodateien mit bis zu 15 GB pro Datei hochladen. Wenn Sie dem Ordner Videos hinzufügen, werden diese gemäß dem diesem Ordner zugewiesenen Videoverarbeitungsprofil kodiert.
...
1. **Verwalten Sie die Videos in dynamischen Medien** anhand der folgenden Schritte:
   ...
   * Video-Assets organisieren und durchsuchen
      ...
      * [Nach Video-Assets suchen](search-assets.md#custompredicates) oder [Assets suchen](managing-assets-touch-ui.md#search-assets)
...
Das adaptive Video-Streaming wird auf einer Vielzahl von iOS-Plattformen unterstützt. Siehe [Referenzanleitung für Scene7 Viewer](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_html5_video_reference.html).
...
Weitere Informationen über [Viewer für AEM und Scene7](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_html5_s7_aem_asset_viewers.html) und [Viewer für AEM Assets](https://marketing.adobe.com/resources/help/en_US/viewers_ref/c_html5_s7_aem_asset_viewers.html) finden Sie im Referenzhandbuch für Adobe Scene7-Viewer.
...
Wenn Sie eine Videokodierungsvorgabe für Ihre primäre Quellvideodatei auswählen oder erstellen, stellen Sie sicher, dass die Vorgabe das gleiche Seitenverhältnis wie die primäre Quellvideodatei hat. Das Seitenverhältnis ist das Verhältnis zwischen Breite und Höhe des Videos.
...
Wenn Sie eine Videokodierungsvorgabe für Ihre primäre Quellvideodatei auswählen (oder erstellen), verwenden Sie diese Tabelle, um die richtige Auflösung Zielgruppe:
...
Wählen Sie eine Videokodierungsvorgabe, die der fps-Rate der primären Quellvideodatei entspricht. Wenn Ihr primäres Quellvideo z. B. 25 fps beträgt, wählen Sie eine Kodierungsvorgabe mit 25 fps. Standardmäßig verwendet die gesamte benutzerdefinierte Kodierung die fps der primären Quellvideodatei. Daher müssen Sie die fps-Einstellung nicht explizit angeben, wenn Sie eine Videokodierungsvorgabe erstellen.
...
Um Video-Assets auf YouTube zu veröffentlichen, richten Sie AEM Assets mit Tags ein. Diese Tags verknüpfen Sie mit einem YouTube-Kanal. Wenn das Tag eines Video-Assets mit dem Tag eines YouTube-Kanals übereinstimmt, wird das Video auf YouTube veröffentlicht. Die Veröffentlichung auf YouTube erfolgt neben einer normalen Veröffentlichung des Videos, solange ein entsprechendes Tag verwendet wird. 
...
1. Gehen Sie auf der Seite zum **[!UICONTROL Hinzufügen von Anmeldedaten zu Ihrem Projekt]** in Schritt 1 wie folgt vor:
   ...
   * Tippen Sie im Dropdownmenü **[!UICONTROL Auf welche Daten greifen Sie zu?]** Dropdown-Liste auf **[!UICONTROL Benutzerdaten.]**
...
1. Klicken Sie oben links in AEM auf das AEM-Logo und anschließend in der linken Leiste auf **[!UICONTROL Tools]** > **[!UICONTROL Bereitstellung]** > **[!UICONTROL Replikation]** > **[!UICONTROL Agenten für Autor.]**
...
* Informationen zum Konfigurieren von YouTube in AEM vor Version 6.4 finden Sie unter [Einrichten von YouTube in AEM vor Version 6.4](/help/assets/video.md#setting-up-youtube-in-aem-before).
...
1. Klicken Sie auf **[!UICONTROL Standard.]** (Fügen Sie dem Auswahlfeld links neben &quot;Standard&quot;kein Häkchen hinzu.)
...
1. Klicken Sie in der Symbolleiste auf **[!UICONTROL Veröffentlichung verwalten.]** Sie müssen möglicherweise auf das Ellipsensymbol (…) on the toolbar to see **[!UICONTROL Manage Publication.]**
...
* For encoding jobs, you can access the configuration page for all AEM workflow email notifications at **[!UICONTROL Tools]** > **[!UICONTROL Operations]** > **[!UICONTROL Web Console]** and by searching for **[!UICONTROL Day CQ Workflow Email Notification Service.]** Siehe [Konfigurieren der E-Mail-Benachrichtigung in AEM](/help/sites-administering/notification.md). You can select or clear the check boxes for **[!UICONTROL Notify on Abort]** or **[!UICONTROL Notify on Complete]** accordingly.
...
1. Verwenden Sie eine Drittanbieteranwendung bzw. einen Dienst, um Ihre Untertiteldatei für ein Video zu erstellen.
   ...
   Wenn Sie das Tool geöffnet haben, geben Sie im Feld **[!UICONTROL Enter URL of video file]** (URL der Videodatei eingeben) die kopierte URL Ihrer Videodatei ein und klicken Sie dann auf **Load** (Laden). Lesen Sie [Erhalten einer URL für ein Asset](/help/assets/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset), um die URL für die Videodatei zu erhalten, die Sie dann in das Feld **[!UICONTROL Enter URL of video file (URL der Videodatei eingeben) einfügen können.]** Internet Explorer, Chrome oder Safari können das Video dann nativ wiedergeben.

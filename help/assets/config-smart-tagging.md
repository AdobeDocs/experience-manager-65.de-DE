...
Bevor Sie mit dem Tagging Ihrer Assets per Smart Content Services beginnen können, integrieren Sie [!DNL Experience Manager Assets] mit der Adobe Developer Console, um den Smart Service von [!DNL Adobe AI] zu nutzen. Nach der Konfiguration trainieren Sie den Service mit einigen Bildern und einem Tag.
...
Um die Smart Content Service-APIs zu verwenden, erstellen Sie eine Integration in der Adobe Developer Console, um Folgendes zu erhalten:

* [!UICONTROL API-SCHLÜSSEL] (generiert im Feld [!UICONTROL CLIENT-ID] der Adobe Developer Console-Integration)
* [!UICONTROL ORGANISATIONS-ID]
* [!UICONTROL CLIENT-GEHEIMNIS] für [!UICONTROL Diensteinstellungen für Smart-Tagging in Assets] der Cloud-Konfiguration in [!DNL Experience Manager]
...
1. Wählen Sie **[!UICONTROL OAuth Server-zu-Server]** aus. Klicken Sie **[!UICONTROL Weiter]**.
Weitere Informationen dazu finden Sie je nach Ihren Anforderungen in der Dokumentation zu Developer Console:

   * Einen Überblick finden Sie unter *Server-zu-Server-Authentifizierung* auf developer.adobe.com.
   * Informationen zum Erstellen von neuen OAuth-Anmeldedaten finden Sie im *OAuth-Handbuch zur Implementierung von Server-zu-Server-Anmeldedaten* unter developer.adobe.com.
   * Informationen zum Migrieren von vorhandenen JWT-Anmeldedaten zu OAuth-Anmeldedaten finden Sie unter *Migration von Dienstkonto-Anmeldedaten (JWT) zu OAuth-Server-zu-Server-Anmeldedaten* unter developer.adobe.com.


1. Wählen Sie auf der Seite **[!UICONTROL Produktprofile auswählen]** die Option **[!UICONTROL Smart Content Services]** aus und klicken Sie anschließend auf die Option **[!UICONTROL Konfiguriertes API speichern]**.
...
Sie müssen die Konfiguration eines technischen IMS-Kontos mithilfe der folgenden Schritte erstellen:
...
1. Verwenden Sie im Dialogfeld „Konfiguration des technischen IMS-Kontos“ die folgenden Werte:
   ...
   | Feld | Beschreibung |
   | -------- | ---------------------------- |
   | Cloud-Lösung | Wählen Sie aus dem Dropdown-Menü die Option **[!UICONTROL Smart-Tags]** aus. |
   ...
   | Umfang | Wird über die [Adobe Developer Console](https://developer.adobe.com/console/) bereitgestellt. |
...
1. Klicken Sie auf `com.day.cq.dam.similaritysearch.internal.impl`. Sie öffnet **[!UICONTROL SimilaritySearch Miscellaneous Tasks]**.—>
...
1. Erweitern Sie das Seitenbedienfeld, um die Schritte anzuzeigen. Ziehen Sie den Schritt **[!UICONTROL Smart-Tag-Asset]** aus dem Abschnitt „DAM-Workflow“ und fügen Sie ihn nach dem Schritt **[!UICONTROL Prozessminiaturansichten]** ein.
...
1. Wechseln Sie in der Benutzeroberfläche [!DNL Experience Manager] zu **[!UICONTROL Tools]** > **[!UICONTROL Workflow]** > **[!UICONTROL Modelle]**.
...
1. Wechseln Sie in der Benutzeroberfläche [!DNL Experience Manager] zu **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL Berichte]**.

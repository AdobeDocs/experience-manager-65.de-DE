...
Ein vollständig interaktives 3D-Asset, wie im     ![3D-Asset, das innerhalb der 3D Media-Komponente angezeigt wird](/help/assets/assets-dm/3d-asset-in-3d-media.png)
...
1. Ziehen Sie das 3D-Asset aus dem Seitenbedienfeld „Assets“ und legen Sie es auf der Komponente **[!UICONTROL 3D Media]** ab, die Sie der Seite zuvor hinzugefügt haben.
   ...
   ![Zuweisen eines 3D-Assets zur 3D Media-Komponente](/help/assets/assets-dm/3d-asset-add.png)

...
[!DNL Assets] vollständig mit [!DNL Sites] und funktioniert nahtlos für alle Anwendungsfälle. Wenn Sie z. B. Web-Seiten erstellen, muss die Variable [!DNL Sites] -Autoren können die digitalen Assets über den Content Finder suchen und verwenden. Die Benutzeroberfläche von [!DNL Assets] entspricht dem von [!DNL Sites]. Siehe [Übersicht über Sites](/help/sites-authoring/page-authoring.md) für ausführliche Informationen.

Die grundlegende Benutzeroberfläche entspricht der von [!DNL Sites]. Siehe [Überblick über die Sites](/help/sites-authoring/page-authoring.md) für ausführliche Informationen.

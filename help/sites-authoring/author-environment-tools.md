...
* über das [Konfigurationsdialogfeld](/help/sites-authoring/editing-content.md#edit-configure-copy-cut-delete-paste) bei bestimmten Komponenten (mithilfe des Symbols „?“ in der Symbolleiste des Dialogfelds); dies zeigt kontextbezogene Hilfe an.
...
* [Layout](/help/sites-authoring/responsive-layout.md) - ermöglicht das Erstellen und Bearbeiten eines responsiven Layouts abhängig vom Gerät (wenn die Seite auf einem Layout-Container basiert)
...
>* Mit dem [Tastaturbefehl](/help/sites-authoring/page-authoring-keyboard-shortcuts.md) `Ctrl-Shift-M` können Sie zwischen der **Vorschau** und dem aktuell ausgewählten Modus (z. B. **Bearbeiten**, **Layout** usw.) wechseln.
>

...
1. Starten Sie die Entwickler-Tools und wählen Sie die Registerkarte **Netzwerk** aus. Klicken Sie auf die Option **Protokoll beibehalten**, bevor Sie die Konsole löschen.

...
>
>* 3.x wird mit [https://localhost:4502/system/console/configMgr/com.day.commons.httpclient](https://localhost:4502/system/console/configMgr/com.day.commons.httpclient)
>* 4.x ist mit [https://localhost:4502/system/console/configMgr/org.apache.http.proxyconfigurator](https://localhost:4502/system/console/configMgr/org.apache.http.proxyconfigurator)
>
...
1. Öffnen Sie die OSGi-Konsole und wählen Sie die **[!UICONTROL Konfiguration]** Registerkarte. ([https://localhost:4502/system/console/configMgr](https://localhost:4502/system/console/configMgr))
1. Wählen Sie das Element Day CQ Search&amp;Promote Configuration aus.
1. Geben Sie die URL in das Feld &quot;Remote Server URI&quot;ein und wählen Sie **[!UICONTROL Speichern]**.
...
1. Navigieren Sie in Experience Manager zu **[!UICONTROL Instrumente]** > **[!UICONTROL Implementierung]** > Auswählen **[!UICONTROL Cloud Services]**.
...
1. Wenn Sie Adobe Search&amp;Promote zum ersten Mal konfigurieren, wählen Sie **[!UICONTROL Jetzt konfigurieren]** , um den Bereich Konfiguration erstellen zu öffnen.

   Um mehr über Search&amp;Promote zu erfahren, wählen Sie **[!UICONTROL Weitere Infos]**.

   ![](assets/chlimage_1-59.png)

1. Geben Sie einen **[!UICONTROL Titel]** , das für Seitenautoren erkennbar ist, und geben Sie eine eindeutige **[!UICONTROL Name]**.
...
1. Im **[!UICONTROL Komponente bearbeiten]** Fügen Sie den Feldern Folgendes hinzu.
   ...
   * **Kontonummer**
   ...
   >[!NOTE]
   >
   >Abrufen dieser Informationen **selbst,** müssen Sie sich zuerst anmelden
   >
   ...
   >**Dabei gilt:**
   >
   >    * **XXXXXXXXXXXX** entspricht Ihrer** Mitglieds-ID**
   >    * **spYYYYYYYY** entspricht Ihrem **Kontonummer**


1. Auswählen **[!UICONTROL Mit Search&amp;Promote verbinden]**.

   Wenn die Meldung angezeigt wird, dass die Verbindung erfolgreich hergestellt wurde, wählen Sie **[!UICONTROL OK]**.

   (Nach dem Verbinden ändert sich der Schaltflächentext in &quot;Erneut mit Search&amp;Promote verbinden&quot;.)

1. Klicken Sie auf **[!UICONTROL OK]**. Die Seite &quot;Search&amp;Promote-Einstellungen&quot;wird für die von Ihnen erstellte Konfiguration angezeigt.
...
1. Öffnen Sie das Dialogfeld **[!UICONTROL Seiteneigenschaften]**. Klicken Sie beispielsweise auf der Seite &quot;Websites&quot;mit der rechten Maustaste auf die Seite und wählen Sie **[!UICONTROL Eigenschaften]**.
...
1. Auswählen **[!UICONTROL Adobe Search&amp;Promote]**, wählen Sie **[!UICONTROL OK]**.

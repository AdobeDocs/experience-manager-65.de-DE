...
>[!NOTE]
>
>Das eCommerce-Framework kann mit jeder eCommerce-Lösung verwendet werden. Certain specifics and examples dealt with here will refer to the [SAP Commerce Cloud](https://www.hybris.com/) solution.
...
* Die `cq:commerceProvider`-Eigenschaft wird auch als Verweis auf die geeignete Commerce-Factory-Definition verwendet.
   ...
   * In diesem Fall können weitere Eigenschaften wie [**Catalog version **konfiguriert werden](#configuringthecatalogversion)(falls zutreffend und verfügbar).
...
* Authentifizierung Es wird davon ausgegangen, dass AEM das *einzige* Web-Front-End ist und daher *alle* Authentifizierungen verarbeitet.

* Untergeordnete Konten AEM erstellt in Hybris für jeden Kunden ein untergeordnetes Konto. Der Benutzername des untergeordneten Kontos ist mit dem AEM-Benutzernamen identisch. Ein kryptografisches Zufallskennwort wird automatisch in AEM erstellt und gespeichert (verschlüsselt).

...
* **Klassische**
Benutzeroberfläche auf Basis der ExtJS-Technologie, die seit AEM 6.4 veraltet ist.
...
>
>* Für verschachtelte Komponenten sind die Werte der folgenden Eigenschaften *must* `REFRESH_PAGE`: >
>  * `aftermove`
>  * `aftercopy`

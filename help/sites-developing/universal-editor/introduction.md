...
Wenn AEM konfiguriert ist und ein lokaler universeller Editor-Dienst ausgeführt wird, müssen Sie einen Reverse-Proxy für den neuen Dienst [im Dispatcher](https://experienceleague.adobe.com/de/docs/experience-manager-dispatcher/using/dispatcher) zulassen.
...
* Das Setup des universellen Editors variiert geringfügig bei 6.5 (wie im aktuellen Dokument [beschrieben](#setup)).

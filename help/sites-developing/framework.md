...
>[!NOTE]
>
>Auf der Seite Seiteneigenschaften der Tags wird empfohlen, Tag-ID (`geometrixx-outdoors:activity/biking`) anstatt den Tag-Basispfad fest zu kodieren (z. B. `/etc/tags/geometrixx-outdoors/activity/biking`).
>

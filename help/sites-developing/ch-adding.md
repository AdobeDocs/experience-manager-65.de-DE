...
Die folgenden Segmente werden mit der [WKND-Tutorial-Site installiert.](getting-started.md)
...
* Zunächst wird der [Geolocation](ch-samplestores.md#contexthub-geolocation-sample-store-candidate) Store zur Bestimmung der Breite des Benutzers verwendet.
* Dann bestimmt das Datenelement für den Monat des [surferinfo-Stores](ch-samplestores.md#contexthub-surferinfo-sample-store-candidate) , welche Jahreszeit es in diesem Breitengrad ist.
...
Es gibt eine Reihe von Optionen zum Debugging von ContextHub, einschließlich der Erstellung von Protokollen. See [Configuring ContextHub for more information.](ch-configuring.md#logging-debug-messages-for-contexthub)
